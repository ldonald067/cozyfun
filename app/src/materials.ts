...
export const MATERIALS: MaterialDef[] = [
  ...
  },
  {
    ...
    label: "Ice",
    slug: "ice",
    description: "Cold solid that freezes nearby liquid, pauses living material, and stills a wellspring so it can be taught again.",
  ...
  },
  {
    ...
    label: "Wellspring",
    slug: "wellspring",
    description: "Carved block that drinks the first material to touch it and pours it back out endlessly; chill it with ice to make it forget and learn a new one.",
