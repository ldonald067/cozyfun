...
export function materialShowcaseScript() {
  return `(() => {
    ...
    // remembered.
    const BLOOM_SHAPES = [
      [[-2,-2],[-1,-2],[1,-2],[2,-2],[-3,-1],[-2,-1],[-1,-1],[0,-1],[1,-1],[2,-1],[3,-1],[-3,0],[-2,0],[-1,0],[1,0],[2,0],[3,0],[-2,1],[2,1]], // 0 cornflower
      ...
      [[-3,-2],[-1,-2],[1,-2],[3,-2],[-3,-1],[-2,-1],[-1,-1],[0,-1],[1,-1],[2,-1],[3,-1],[-2,0],[-1,0],[1,0],[2,0]], // 4 tulip
